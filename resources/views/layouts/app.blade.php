                ...
                <div class="flex justify-between items-center py-2">
                    ...
                    <div>
                        ...
                        <ul class="flex items-center">
                            ...
                            @guest
                                <li class="nav-item">
                                    <a class=" mr-4 font-notmal text-lg text-black-50  font-semibold" href="{{ route('login') }}">{{ __('Login') }}</a>
                                </li>
                                @if (Route::has('register'))
                                        <a class="mr-4 font-notmal text-lg text-black-50  font-semibold" href="{{ route('register') }}">{{ __('Register') }}</a>
                                @endif
                            @else
                                <li>
                                    <div>
                                        <a class="font-notmal text-lg text-black-50  font-semibold" href="{{ route('logout') }}"
