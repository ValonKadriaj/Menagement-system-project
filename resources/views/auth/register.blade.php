...
<div class="lg:w-1/2 lg:mx-auto bg-white p-6 md:py-12 md:px-16 rounded-lg shadow">
    ...
    <form   
        ...
        <div class="field mb-6">
            <label class="label text-sm mb-2 block">Name</label>
            <div class="control">
                <input 
                    type="text"
        ...
        <div class="field mb-6">
            <label class="label text-sm mb-2 block">Password Confirmation</label>
            <div class="control">
                <input 
                    type="password"
                    class="input bg-transparent outline-none border border-gray-500 rounded p-2 text-xs w-full"
        ...
        <div>
            <div class="form-control">
                <button type="submit" class="button  mr-4">Register</button>
                <a href="/login" class="button-2">Login</a>
            </div>
        </div>
    </form>
